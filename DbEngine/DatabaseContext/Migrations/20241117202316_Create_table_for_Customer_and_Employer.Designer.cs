...
namespace DatabaseContext.Migrations
{
    ...
    [Migration("20241117202316_Create_table_for_Customer_and_Employer")]
    partial class Create_table_for_Customer_and_Employer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.CustomerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.OrderScoresCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrderScoresCustomer", "dbo");
                });

            modelBuilder.Entity("Models.OrderScoresEmployer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrderScoresEmployer", "dbo");
                });
            ...
            modelBuilder.Entity("Models.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreatedAt = new DateTime(2024, 11, 17, 20, 23, 15, 733, DateTimeKind.Utc).AddTicks(7425),
                            DateUpdatedAt = new DateTime(2024, 11, 17, 20, 23, 15, 733, DateTimeKind.Utc).AddTicks(7428),
                            FirstName = "Alexey",
                            IsActived = true,
                            LastName = "Franchuk",
                        ...
                        new
                        {
                            ...
                            DateCreatedAt = new DateTime(2024, 11, 17, 20, 23, 15, 733, DateTimeKind.Utc).AddTicks(7430),
                            DateUpdatedAt = new DateTime(2024, 11, 17, 20, 23, 15, 733, DateTimeKind.Utc).AddTicks(7430),
                            FirstName = "Igor",
                            IsActived = true,
                            LastName = "Menschin",
            ...
            modelBuilder.Entity("Models.CustomerProfile", b =>
                {
                    b.HasOne("Models.User", "User")
                        ...
                        .HasForeignKey("Models.CustomerProfile", "UserId")
            ...
            modelBuilder.Entity("Models.OrderScoresCustomer", b =>
                {
                    b.HasOne("Models.CustomerProfile", "CustomerProfile")
                        .WithMany("OrderScoresCustomers")
            ...
            modelBuilder.Entity("Models.OrderScoresEmployer", b =>
                {
                    b.HasOne("Models.EmployerProfile", "EmployerProfile")
                        .WithMany("OrderScoresEmployers")
            ...
            modelBuilder.Entity("Models.CustomerProfile", b =>
                {
                    b.Navigation("OrderScoresCustomers");
                });

            modelBuilder.Entity("Models.EmployerProfile", b =>
                {
                    b.Navigation("OrderScoresEmployers");
                });
